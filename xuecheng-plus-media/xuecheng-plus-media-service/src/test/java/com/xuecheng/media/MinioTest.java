...
//                .object("1.mp4")//对象名 在桶下存储该文件
    ...
    public void test_getFile() throws Exception {
        ...
        //指定输出流
        FileOutputStream outputStream = new FileOutputStream(new File("D:\\zz\\d1.mp4"));
        IOUtils.copy(inputStream, outputStream);

        //校验文件的完整性对文件的内容进行md5
        FileInputStream fileInputStream1 = new FileInputStream(new File("D:\\zz\\33.mp4"));
        String source_md5 = DigestUtils.md5Hex(fileInputStream1);
        FileInputStream fileInputStream = new FileInputStream(new File("D:\\zz\\d1.mp4"));
